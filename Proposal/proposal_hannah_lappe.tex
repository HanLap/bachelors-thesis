...
{\hint{(this page)}{
    ...
    Modeling languages have long been an important part in software engineering and business planning. They are used to to express complex processes in a, comprehensive and easy to understand, way. Extensive research in the field of model driven engineering (MDE) \dots

    Relaxed conformance modelling approaches intend to ease use of graphical modelling tools by allowing the user to create  
...
{\hint{(0,75 pages)}{
    ...
    The CouchEdit Framework is designed to translate concrete syntax into abstract syntax, using a syntax meta model.
...
The purpose of this study is to develop a domain specific language, which can be utilised to define new syntax processors for the CouchEdit framework. This DSL aims to allow users to configure the CouchEdit framework so that it can comprehend and process any specified concrete model syntax to an abstract syntax model representation. 
