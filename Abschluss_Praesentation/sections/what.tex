...
%   \hspace{-1cm}
%   \centering
%   \includegraphics[width=9cm]{images/"editor"}
% \end{frame}
...
\begin{frame}
  ...
  \hspace{-1.5cm}
  \centering
  \includegraphics[width=8cm]{images/"couchedit-main"}
\end{frame}
...
\begin{frame}
  ...
  \hspace{-1cm}
  \centering
  \includesvg[width=10cm]{images/"presentation - hypergraph"}
\end{frame}
...
\begin{frame}
  ...
  \hspace{-1cm}
  \centering
  \includesvg[width=10cm]{images/"component - bus"}
\end{frame}