...
\begin{description} 
  \item[RQ1:] \comment{was mach ich wegen dieser blöden frage?} Is it possible to define a concise metamodel that covers \textsc{CouchEdit}'s complete feature set?
...
This thesis is organized in the following structure: \Cref{ch:fundamentals}, lays out fundamentals required in the rest of the thesis. This includes a comprehensive summary of the \textsc{CouchEdit} architecture as well as modeling theory. Furthermore this Chapter summarizes related work in the relevant fields. Following that, in \Cref{ch:design} the developed metamodel is described in detail. The prototypical implementation that was developed alongside the metamodel, is then laid out in \Cref{ch:prototype}. Chapter \Cref{ch:evaluation} provides considerations about the evaluation of the artifact, as well as the evaluation results. Finally \Cref{ch:conclusion} gives perspectives on the future of this project, as well as takeaways from this research.