...
Implementation in the form of such extension functions allows for a more natural navigation through the hypergraph, which is especially useful when traversing longer distances, which will become apparent in the following sections. \Cref{app:navigationfunctions} contains a list of these navigation functions.
