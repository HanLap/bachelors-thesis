...
\begin{lstlisting}[language=customLang, caption={Example on how to get all \texttt{GOs} contained by a given element \texttt{go}, in the CouchEdit architecture}, captionpos=b]
...
\comment{still gotta find better closure for this chapter}
