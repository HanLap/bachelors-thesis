...
This thesis proposes an architecture that can create modeling language configurations for \textsc{CouchEdit}. This architecture aims to increase developer accessibility by reducing the amount of code and framework knowledge needed to specify new configurations. 
